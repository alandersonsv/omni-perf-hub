-- RE-RUN MIGRATION WITH FIXED UNIQUE INDEX FOR META ADS (no expressions in table constraints)

-- META ADS INSIGHTS DAILY
...
-- Unique composite key using expression index to handle nullable IDs
CREATE UNIQUE INDEX IF NOT EXISTS ux_meta_ads_insights_daily_key

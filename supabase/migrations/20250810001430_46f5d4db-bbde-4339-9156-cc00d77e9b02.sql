-- MIGRATION v2: Fix CREATE POLICY syntax by dropping existing policies before creating
-- 1) Enums (same as before)
DO $$ BEGIN
...
DROP POLICY IF EXISTS "read_own_invoices" ON public.invoices;
CREATE POLICY "read_own_invoices" ON public.invoices
  FOR SELECT USING (user_id = auth.uid() OR email = auth.email());
...
DROP POLICY IF EXISTS "read_own_billing_events" ON public.billing_events;
CREATE POLICY "read_own_billing_events" ON public.billing_events
  FOR SELECT USING (user_id = auth.uid() OR email = auth.email());
...
DROP POLICY IF EXISTS "Templates are readable by everyone" ON public.dashboard_templates;
CREATE POLICY "Templates are readable by everyone" ON public.dashboard_templates FOR SELECT USING (true);
...
CREATE POLICY "Agency members can view dashboards" ON public.dashboards
  FOR SELECT USING (
    auth.uid() IN (
...
CREATE POLICY "Owners/Admins can manage dashboards" ON public.dashboards
  FOR ALL USING (
    auth.uid() IN (
...
CREATE POLICY "Agency members can view dashboard widgets" ON public.dashboard_widgets
  FOR SELECT USING (
    EXISTS (
...
CREATE POLICY "Owners/Admins can manage dashboard widgets" ON public.dashboard_widgets
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.dashboards d
      JOIN public.team_members tm ON tm.agency_id = d.agency_id
...
DROP POLICY IF EXISTS "Read metrics in agency" ON public.user_metrics;
CREATE POLICY "Read metrics in agency" ON public.user_metrics
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Manage own or admin metrics" ON public.user_metrics;
CREATE POLICY "Manage own or admin metrics" ON public.user_metrics
  FOR ALL USING (
...
DROP POLICY IF EXISTS "Agency members can view shops" ON public.shops;
CREATE POLICY "Agency members can view shops" ON public.shops
  FOR SELECT USING (auth.uid() IN (SELECT tm.id FROM public.team_members tm WHERE tm.agency_id = shops.agency_id));
DROP POLICY IF EXISTS "Agency admins can manage shops" ON public.shops;
CREATE POLICY "Agency admins can manage shops" ON public.shops
  FOR ALL USING (
    auth.uid() IN (
      SELECT tm.id FROM public.team_members tm
...
DROP POLICY IF EXISTS "Agency members can view categories" ON public.categories;
CREATE POLICY "Agency members can view categories" ON public.categories
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage categories" ON public.categories;
CREATE POLICY "Agency admins can manage categories" ON public.categories
  FOR ALL USING (
    EXISTS (
...
CREATE POLICY "Agency members can view products" ON public.products
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage products" ON public.products;
CREATE POLICY "Agency admins can manage products" ON public.products
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency members can view product variations" ON public.product_variations;
CREATE POLICY "Agency members can view product variations" ON public.product_variations
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage product variations" ON public.product_variations;
CREATE POLICY "Agency admins can manage product variations" ON public.product_variations
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency admins can manage customers" ON public.customers;
CREATE POLICY "Agency admins can manage customers" ON public.customers
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency members can view orders" ON public.orders;
CREATE POLICY "Agency members can view orders" ON public.orders
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage orders" ON public.orders;
CREATE POLICY "Agency admins can manage orders" ON public.orders
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency members can view order items" ON public.order_items;
CREATE POLICY "Agency members can view order items" ON public.order_items
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage order items" ON public.order_items;
CREATE POLICY "Agency admins can manage order items" ON public.order_items
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency members can view products_categories" ON public.products_categories;
CREATE POLICY "Agency members can view products_categories" ON public.products_categories
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage products_categories" ON public.products_categories;
CREATE POLICY "Agency admins can manage products_categories" ON public.products_categories
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency members can view sync jobs" ON public.sync_jobs;
CREATE POLICY "Agency members can view sync jobs" ON public.sync_jobs
  FOR SELECT USING (
...
DROP POLICY IF EXISTS "Agency admins can manage sync jobs" ON public.sync_jobs;
CREATE POLICY "Agency admins can manage sync jobs" ON public.sync_jobs
  FOR ALL USING (
    EXISTS (
      SELECT 1 FROM public.shops s JOIN public.team_members tm ON tm.agency_id = s.agency_id
...
DROP POLICY IF EXISTS "Agency members can view sync logs" ON public.sync_logs;
CREATE POLICY "Agency members can view sync logs" ON public.sync_logs
  FOR SELECT USING (
    EXISTS (
